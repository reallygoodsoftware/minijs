...
export default class Entity {
  ...
  _sanitizeExpression(expr) {
    // Add proxyWindow
    // ! FIXME:
    // - changing the variable only works for first variable found in a statement.
    // - variables are replace even for non variable values in console.log('selectedTags');
